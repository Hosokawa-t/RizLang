...
extern RizValue native_argv_fn(RizValue* a, int c);
extern RizValue native_argc_fn(RizValue* a, int c);
extern RizValue native_script_path_fn(RizValue* a, int c);
extern RizValue native_parse_flags(RizValue* a, int c);
extern RizValue native_read_file(RizValue* a, int c);
extern RizValue native_write_file(RizValue* a, int c);
extern RizValue native_read_lines(RizValue* a, int c);
extern RizValue native_write_lines(RizValue* a, int c);
extern RizValue native_parse_csv(RizValue* a, int c);
extern RizValue native_read_csv(RizValue* a, int c);
extern RizValue native_parse_tsv(RizValue* a, int c);
extern RizValue native_read_tsv(RizValue* a, int c);
extern RizValue native_file_exists(RizValue* a, int c);
extern RizValue native_dir_exists(RizValue* a, int c);
extern RizValue native_list_dir(RizValue* a, int c);
extern RizValue native_walk_dir(RizValue* a, int c);
extern RizValue native_glob(RizValue* a, int c);
extern RizValue native_mkdir_fn(RizValue* a, int c);
extern RizValue native_cwd(RizValue* a, int c);
extern RizValue native_getenv_fn(RizValue* a, int c);
extern RizValue native_basename(RizValue* a, int c);
extern RizValue native_dirname(RizValue* a, int c);
extern RizValue native_join_path(RizValue* a, int c);
extern RizValue native_json_parse(RizValue* a, int c);
extern RizValue native_json_stringify(RizValue* a, int c);
extern RizValue native_read_json(RizValue* a, int c);
extern RizValue native_write_json(RizValue* a, int c);
...
void aot_setup_builtins(void) {
    ...
    aot_register_user_fn("argv", (NativeFnPtr)native_argv_fn, 0);
    aot_register_user_fn("argc", (NativeFnPtr)native_argc_fn, 0);
    aot_register_user_fn("script_path", (NativeFnPtr)native_script_path_fn, 0);
    aot_register_user_fn("parse_flags", (NativeFnPtr)native_parse_flags, -1);
    ...
    aot_register_user_fn("read_lines", (NativeFnPtr)native_read_lines, 1);
    aot_register_user_fn("write_lines", (NativeFnPtr)native_write_lines, 2);
    aot_register_user_fn("parse_csv", (NativeFnPtr)native_parse_csv, -1);
    aot_register_user_fn("read_csv", (NativeFnPtr)native_read_csv, -1);
    aot_register_user_fn("parse_tsv", (NativeFnPtr)native_parse_tsv, -1);
    aot_register_user_fn("read_tsv", (NativeFnPtr)native_read_tsv, -1);
    aot_register_user_fn("file_exists", (NativeFnPtr)native_file_exists, 1);
    aot_register_user_fn("dir_exists", (NativeFnPtr)native_dir_exists, 1);
    aot_register_user_fn("list_dir", (NativeFnPtr)native_list_dir, -1);
    aot_register_user_fn("walk_dir", (NativeFnPtr)native_walk_dir, -1);
    aot_register_user_fn("glob", (NativeFnPtr)native_glob, 1);
    aot_register_user_fn("mkdir", (NativeFnPtr)native_mkdir_fn, -1);
    aot_register_user_fn("cwd", (NativeFnPtr)native_cwd, 0);
    aot_register_user_fn("getenv", (NativeFnPtr)native_getenv_fn, -1);
    aot_register_user_fn("basename", (NativeFnPtr)native_basename, 1);
    aot_register_user_fn("dirname", (NativeFnPtr)native_dirname, 1);
    aot_register_user_fn("join_path", (NativeFnPtr)native_join_path, -1);
    aot_register_user_fn("json_parse", (NativeFnPtr)native_json_parse, 1);
    aot_register_user_fn("json_stringify", (NativeFnPtr)native_json_stringify, -1);
    aot_register_user_fn("read_json", (NativeFnPtr)native_read_json, 1);
    aot_register_user_fn("write_json", (NativeFnPtr)native_write_json, -1);
